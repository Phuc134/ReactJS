...
const ModalUpdateUser = (props) => {
    console.log(props);
    const { showUpdate, setShowUpdate, dataUpdate, fetchListUsers, setDataUpdate } = props;
    const handleClose = () => {
        setEmail("");
        setPassword("");
        setUsername("");
            ...
            <Modal show={showUpdate} onHide={handleClose} size="xl" backdrop='static' className="modal-add-user">
                ...
                <Modal.Body><form className="row g-3" >
                    <div className="col-md-6">
                        ...
                        <input disabled type="email" value={email} onChange={(event) => setEmail(event.target.value)} className="form-control" />
                    </div>
                    <div className="col-md-6">
                        <label className="form-label">Password</label>
                        <input disabled type="password" value={password} onChange={(event) => setPassword(event.target.value)} className="form-control" />
                    </div>
                    <div className="col-md-6">
